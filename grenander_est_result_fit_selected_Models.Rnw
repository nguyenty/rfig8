...
\title{Analyze RNASeq Data from G8P2 RFI Lines Using QuasiSeq Package}
...
<<cache=TRUE,echo=FALSE,tidy=FALSE,results='hide',echo=FALSE>>=
# model 1####
...
<<tidy=FALSE,results='asis',cache=TRUE,echo=FALSE>>=
# model 6####
...
xtable(out, caption = "Model 6",floating=TRUE,type="latex",
       table.placement='h')
...
out <- data.frame(FDR =c(0.05, 0.10, 0.15, .20), degene = degene, lf1 = lf1)
colnames(out) <- c("FDR", "DEGs", "log2(FC)>=1")
xtable(out, caption = "Model 7",floating=TRUE,type="latex",
       table.placement='h')
...
out <- data.frame(FDR =c(0.05, 0.10, 0.15, .20), degene = degene, lf1 = lf1)
colnames(out) <- c("FDR", "DEGs", "log2(FC)>=1")
xtable(out, caption = "Model 8",floating=TRUE,type="latex",
       table.placement='h'
)
@
...
out <- data.frame(FDR =c(0.05, 0.10, 0.15, .20), degene = degene, lf1 = lf1)
colnames(out) <- c("FDR", "DEGs", "log2(FC)>=1")
xtable(out, caption = "Model 12",floating=TRUE,type="latex",
       table.placement='h')
...
out <- data.frame(FDR =c(0.05, 0.10, 0.15, .20), degene = degene, lf1 = lf1)
colnames(out) <- c("FDR", "DEGs", "log2(FC)>=1")
xtable(out, caption = "Model 13",floating=TRUE,type="latex",
       table.placement='h')
...
out <- data.frame(FDR =c(0.05, 0.10, 0.15, .20), degene = degene, lf1 = lf1)
colnames(out) <- c("FDR", "DEGs", "log2(FC)>=1")
xtable(out, caption = "Model 14",floating=TRUE,type="latex",
       table.placement='h')
...
out <- data.frame(FDR =c(0.05, 0.10, 0.15, .20), degene = degene, lf1 = lf1)
colnames(out) <- c("FDR", "DEGs", "log2(FC)>=1")
xtable(out, caption = "Model 15",floating=TRUE,type="latex",
       table.placement='h')
...
out <- data.frame(FDR =c(0.05, 0.10, 0.15, .20), degene = degene, lf1 = lf1)
colnames(out) <- c("FDR", "DEGs", "log2(FC)>=1")
xtable(out, caption = "Model 16",floating=TRUE,type="latex",
       table.placement='h')

@

<<tidy=FALSE,echo=FALSE,cache=TRUE>>=
pairs(log(cbind(pvalue_line12, pvalue_line13, pvalue_line14, pvalue_line15, pvalue_line16)),
      lower.panel=panel.smooth, upper.panel=panel.cor,diag.panel=panel.hist)
...
<<tidy=FALSE,echo=FALSE,cache=TRUE>>=
pairs(log(cbind(pvalue_line6, pvalue_line7, pvalue_line8,pvalue_line12, pvalue_line13, pvalue_line14, pvalue_line15, pvalue_line16)),
      lower.panel=panel.smooth, upper.panel=panel.cor,diag.panel=panel.hist)
...
id_de_G8_20qvalue <- result_sum(result, 0.2)$id_de_gene
g9_out <- read.table("DE_gene_single_end_qvalue20.txt",
                     header = T)

gene_list <- intersect(id_de_G8_20qvalue,g9_out$GeneID)
#gene_list
length(intersect(id_de_G8_20qvalue,g9_out$GeneID))
mean_line1 <- apply(counts[gene_list,Line ==1]+1,1,mean)
mean_line2 <- apply(counts[gene_list,Line ==2]+1,1,mean)
lfc <- abs(log2(mean_line1) - log2(mean_line2))
which(lfc >=1)
@
